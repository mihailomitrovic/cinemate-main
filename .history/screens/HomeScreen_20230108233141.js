  ...
  return (
    <View style = {styles.background}>
      ...
      <View style = {styles.pickContainerA}>
        <TouchableOpacity style = {styles.pickA} onPress = {() => {setFilter('name'); console.log(filter)}}>
        <Text style = {styles.pickTextA}>Name</Text>
        </TouchableOpacity>
        <TouchableOpacity style = {styles.pickA} onPress = {() => {setFilter('runtime'); console.log(filter)}}>
