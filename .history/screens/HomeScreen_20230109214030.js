  ...
  return (
    <View style = {styles.background}>
      ...
      <View style = {styles.pickContainerA}>
        <TouchableOpacity style = {filter === 'name' ? styles.pickA : styles.pickB} onPress = {() => {setFilter('name', previousState => !previousState); console.log(filter)}}>
        <Text style = {filter === 'name' ? styles.pickTextA : styles.pickTextB}>Title</Text>
        </TouchableOpacity>
        <TouchableOpacity style = {filter === 'runtime' ? styles.pickA : styles.pickB} onPress = {() => {setFilter('runtime', previousState => !previousState); console.log(filter)}}>
        <Text style = {filter === 'runtime' ? styles.pickTextA : styles.pickTextB}>Runtime</Text>
        </TouchableOpacity>
        <TouchableOpacity style = {filter === 'year' ? styles.pickA : styles.pickB} onPress = {() => {setFilter('year', previousState => !previousState); console.log(filter)}}>
