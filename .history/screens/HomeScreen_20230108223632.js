  ...
  return (
    <View style = {styles.background}>
      ...
      <View style = {styles.pickContainerA}>
        <TouchableOpacity style = {styles.pickA} onPress = {({'runtime'}) => getMovies}>
        <Text style = {styles.pickTextA}>Runtime</Text>
        </TouchableOpacity>
        <TouchableOpacity style = {styles.pickA} onPress = {('title') => getMovies}>
        <Text style = {styles.pickTextA}>Title</Text>
        </TouchableOpacity>
        <TouchableOpacity style = {styles.pickA} onPress = {({'year'}) => getMovies}>
