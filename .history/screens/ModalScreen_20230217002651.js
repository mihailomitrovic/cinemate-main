...
import { doc, setDoc, arrayUnion, DocumentReference, Document, collection} from '@firebase/firestore'

const ModalScreen = ({route}) => {
  const fixedDays = ["Monday", "Tuesday", "Wednesday","Thursdayy", "Friday","Saturday","Sunday"];
