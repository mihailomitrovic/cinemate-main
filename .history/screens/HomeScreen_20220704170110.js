...
const movieRef = [
  ...
  showtimes: ["16:00", "17:00", "18:00", "19:00", "20:00", "21:00"],
  ...
  runtime: "2h 20m",
  days: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
  showtimes: ["16:00", "17:00", "18:00", "19:00", "20:00", "21:00", "22:00"],
  ...
  return (
    <View style = {styles.background}>
      ...
      <FlatList
      data = {movieRef.sort((a,b) => a.name.localeCompare(b.name))}
