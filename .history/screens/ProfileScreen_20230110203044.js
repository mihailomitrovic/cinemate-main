...
import { doc, getDoc, deleteDoc, query, collection} from '@firebase/firestore'
  ...
  const handleDeleteProfile =() => {
    ...
    .then(() => {
      ...
      .then(() => {
        ...
        const q = query(bookingsRef, where("users","array-contains",korisnikID));
        q.array.forEach(element => {
          element.ref.delete();
        });
