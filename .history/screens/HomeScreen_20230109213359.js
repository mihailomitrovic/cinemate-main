  ...
  return (
    <View style = {styles.background}>
      ...
      <View style = {styles.pickContainerA}>
        <TouchableOpacity style = {filter === 'name' ? styles.pickA : styles.pickB} onPress = {() => {setFilter('name'); console.log(filter)}}>
        ...
        <TouchableOpacity style = {filter === 'year' ? styles.pickA : styles.pickB} onTouchStart = {() => {setFilter('year'); console.log(filter)}}>
